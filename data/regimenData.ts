...
export const regimenData: RegimenData = {
  ...
  sections: [
    ...
    {
      id: "salvamentos",
      title: "SALVAMENTO, INCENDIOS Y OTROS TRABAJOS: 1. SALVAMENTOS",
      content: [
        {
          type: "table",
    ...
    },
     {
      ...
      content: [
          ...
          },
          {
              ...
              rows: [
                  { id: "i1", Categoría: "HABITACIONALES", Tipo: "Casa Deptos./ Casa Oficina de más de 2 Pisos", Subtipo: "", "1º Dot": "2", "2º Dot": "1", "U. Esc": "1", "Cist.": "2", "G.E.R.": "", "E.B.E.E.": "", "U.Liv.": "OP", "UAR": "", "PCM": "", "UM": "", "Usina": "", "JEFE": "" },
