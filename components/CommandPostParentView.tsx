...
const CommandPostParentView: React.FC<CommandPostParentViewProps> = ({ unitReportData, commandPersonnel, servicePersonnel }) => {
    ...
    const TabButton = ({ tabId, children }: { tabId: 'summary' | 'tactical', children: React.ReactNode }) => (
        <button
